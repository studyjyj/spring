...
<body>
	...
	<form action="${conPath }/update.do" method="POST">
		...
		<table>
			...
			<tr><th>이름</th><td><input type="text" name="ename" value="${empDto.ename }"></td>
			</tr>
			<tr>
				<th>직책</th>
				<th><input type="text" name="job" value="${empDto.job}"></th>
			</tr>
			<tr>
				<th>상사사번</th>
			...
			<tr>
				<td colspan="2">
					...
					onclick="location.href='${conPath}/empDeptList.do'">
				</td>
			</tr>
		</table>
	</form>
